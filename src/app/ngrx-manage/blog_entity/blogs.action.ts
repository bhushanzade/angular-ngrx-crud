...
export enum UserBlogsActionTypes {
  BLOGS_FETCH_START = '[USER BLOGS ENTITY] BLOGS_FETCH_START',
  BLOGS_FETCH_COMPLETE = '[USER BLOGS ENTITY] BLOGS_FETCH_COMPLETE',
  BLOG_ADD_START = '[USER BLOGS ENTITY] BLOGS_ADD_START',
  BLOGS_ADD_COMPLETE = '[USER BLOGS ENTITY] BLOGS_ADD_COMPLETE',
  BLOG_EDIT_START = '[USER BLOGS ENTITY] BLOGS_EDIT_START',
  BLOGS_EDIT_COMPLETE = '[USER BLOGS ENTITY] BLOGS_EDIT_COMPLETE',
  BLOG_DETIAL_START = '[USER BLOGS ENTITY] BLOG_DETIAL_START',
  BLOG_DETIAL_COMPLETE = '[USER BLOGS ENTITY] BLOG_DETIAL_COMPLETE',
  BLOG_DELETE_START = '[USER BLOGS ENTITY] BLOG_DELETE_START',
  BLOG_DELETE_COMPLETE = '[USER BLOGS ENTITY] BLOG_DELETE_COMPLETE',
}
